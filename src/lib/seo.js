...
export const getSEOTags = ({
  ...
  return {
    ...
    openGraph: {
      ...
      url: openGraph?.url || `https://${appUrl}/`,
      siteName: openGraph?.title,
      // If you add an opengraph-image.(jpg|jpeg|png|gif) image to the /app folder, you don't need the code below
      images: [
        {
          url: `https://${appUrl}/og-image.png`,
          width: 1200,
          height: 660,
        },
      ],
    ...
    <script
      ...
      dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          image: `https://${appUrl}/icon.png`,
          url: `https://${appUrl}/`,
          author: {
            "@type": "Person",
            name: "Abhishek Kumar",
          },
          datePublished: "25-08-09",
          applicationCategory: "InvoiceApplication",
          aggregateRating: {
